...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_map_all_keywords_to_their_token() -> Result<(), String> {
    let cases: &[(&str, Token)] = &[
        ("all",           Token::All),
        ("and",           Token::And),
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_identify_keyword_prefix_as_ident() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_hex_literal_from_single_digit() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_integer_followed_by_ms_ident_suffix() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_integer_followed_by_s_ident_suffix() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_duration_from_integer_then_ms_at_end_of_input() -> Result<(), String> {
    eq(lex("300ms")?, vec![Token::Duration(300, DurationUnit::Ms)])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_duration_from_integer_s_followed_by_punctuation() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_minus_token_from_minus_not_followed_by_gt() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_minus_token_whitespace_gt() -> Result<(), String> {
    msg_contains(&expect_lex_err("- >")?, "unexpected character")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_arrow_from_hyphen_gt_pair() -> Result<(), String> {
    eq(lex("->")?, vec![Token::Arrow])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_get_arrow_when_surrounded_by_identifiers() -> Result<(), String> {
    eq(
        lex("a -> b")?,
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_strip_leading_and_trailing_whitespace() -> Result<(), String> {
    eq(lex("  fn  ")?, vec![Token::Fn])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_treat_newlines_as_whitespace() -> Result<(), String> {
    eq(lex("\nfn\n")?, vec![Token::Fn])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_treat_tabs_as_whitespace() -> Result<(), String> {
    eq(lex("\t fn \t")?, vec![Token::Fn])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_discard_line_comment() -> Result<(), String> {
    eq(lex("fn // this is a comment\n")?, vec![Token::Fn])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_discard_line_comment_without_trailing_newline() -> Result<(), String> {
    eq(lex("fn // end of file")?, vec![Token::Fn])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_not_consume_next_line_after_comment() -> Result<(), String> {
    eq(lex("fn // first\nnode")?, vec![Token::Fn, Token::Node])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_produce_empty_token_stream_from_comment_only_source() -> Result<(), String> {
    eq(lex("// just a comment")?, vec![])
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_produce_empty_token_stream_from_empty_input() -> Result<(), String> {
    eq(lex("")?, vec![])
}
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_detect_first_token_at_line_1_col_1() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_detect_second_token_column_after_first_token_and_space() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_detect_line_2_for_token_on_second_line() -> Result<(), String> {
    let toks = lex_spans("fn\nnode")?;
    let (_, span) = token_at(&toks, 1)?;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_put_token_after_comment_on_next_line() -> Result<(), String> {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_unterminated_string_literal() -> Result<(), String> {
    msg_contains(&expect_lex_err("\"unterminated")?, "unterminated string")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_string_literal_containing_only_newline() -> Result<(), String> {
    msg_contains(&expect_lex_err("\"line one\nline two\"")?, "unterminated string")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_unexpected_character() -> Result<(), String> {
    msg_contains(&expect_lex_err("@")?, "unexpected character")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_hex_prefix_without_digits() -> Result<(), String> {
    msg_contains(&expect_lex_err("0x")?, "0x")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_reject_hex_prefix_followed_by_non_hex_character() -> Result<(), String> {
    msg_contains(&expect_lex_err("0xg")?, "0x")
}

// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
#[test]
fn should_create_error_message_with_line_and_column() -> Result<(), String> {
